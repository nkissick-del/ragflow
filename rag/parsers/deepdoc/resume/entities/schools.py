...
def select(nm):
    ...
    # Use a mask directly on TBL instead of deepcopy
    hit_alias_mask = TBL["alias"].map(lambda x: nm in set(x.split("+")))
    res = TBL[((TBL.name_cn == nm) | (TBL.name_en == nm) | hit_alias_mask)]
