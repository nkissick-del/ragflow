...
class Recognizer:
    ...
    def create_inputs(self, imgs, im_info):
        ...
        inputs["im_shape"] = np.array([info["im_shape"] for info in im_info], dtype="float32")
        inputs["scale_factor"] = np.array([info["scale_factor"] for info in im_info], dtype="float32")
    ...
    def postprocess(self, boxes, inputs, thr):
        ...
        def compute_iou(box, boxes):
            ...
            iou = np.where(union_area > 0, iou, 0.0)
