...
def setup_mocks():
    ...
    # rag.utils package - UNMOCKED (Real package should be used)
    ...
    # Mock common.token_utils - UNMOCKED
    ...
    # Mock common.config_utils - UNMOCKED
    ...
    # Mock common.settings - UNMOCKED
    # mock_settings = MagicMock()
    # sys.modules["common.settings"] = mock_settings

    # Mock common package - UNMOCKED (mostly)
