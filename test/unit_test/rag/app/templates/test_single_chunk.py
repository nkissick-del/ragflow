...
from rag.app.templates import single_chunk
...
class TestSingleChunk(unittest.TestCase):
    def test_chunk_txt(self):
        ...
        with patch("rag.app.templates.single_chunk.get_text") as mock_get_text:
    ...
    @patch("rag.app.templates.single_chunk.Docx")
    def test_chunk_docx(self, mock_docx):
